...
class PluginGiteaIntegrationPermissionsMenu extends CommonGLPI
{
    ...
    {
        return __("Gitea Permissions", "gitlabintegration");
    }
    ...
    static function getMenuContent()
    {
        ...
        $itemtypes = ['PluginGiteaIntegrationProfiles' => 'profiles'];
